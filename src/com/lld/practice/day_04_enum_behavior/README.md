...
## Package
```
com.lld.practice.day_04_enum_behavior.submission
```
...
```bash
cd /Users/y0p03mn/preparation/src
java com.lld.practice.day_04_enum_behavior.submission.ExcerciseOne
java com.lld.practice.day_04_enum_behavior.submission.ExcerciseTwo
java com.lld.practice.day_04_enum_behavior.submission.ExcerciseThree
```
