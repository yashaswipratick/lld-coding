...
## Package
All Java files use:
`com.lld.practice.day_05_model_separation.submission`
...
```bash
cd /Users/y0p03mn/preparation/src
java com.lld.practice.day_05_model_separation.submission.ExcerciseOne
java com.lld.practice.day_05_model_separation.submission.ExcerciseTwo
java com.lld.practice.day_05_model_separation.submission.ExcerciseThree
java com.lld.practice.day_05_model_separation.submission.ExcerciseFour
```
