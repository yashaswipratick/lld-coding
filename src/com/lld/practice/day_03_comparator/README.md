...
## Package
```
com.lld.practice.day_03_comparator.submission
```
...
```bash
cd /Users/y0p03mn/preparation/src
java com.lld.practice.day_03_comparator.submission.ExcerciseOne
java com.lld.practice.day_03_comparator.submission.ExcerciseTwo
java com.lld.practice.day_03_comparator.submission.ExcerciseThree
java com.lld.practice.day_03_comparator.submission.ExcerciseFour
java com.lld.practice.day_03_comparator.submission.ExcerciseFive
```
